...
fibonacci :: TestCase
fibonacci = ("Fibonacci with nested loops !DOESN'T TERMINATE!", "MoO moO MoO mOo MOO OOM MMM moO moOMMM mOo mOo moO MMM mOo MMM moO moOMOO MOo mOo MoO moO moo mOo mOo moo")
